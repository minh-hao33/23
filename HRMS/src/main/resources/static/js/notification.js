$(document).ready(function() {
  // Thông tin người dùng hiện tại (sẽ được lấy từ session thực tế)
  let currentUser = {
    username: 'ntdu', // Sẽ được thay thế bằng username thực tế từ session
  ...
  function loadNotifications() {
    $.ajax({
      ...
      success: function(response) {
        // Extract data from ResultData wrapper
        const data = response.data || [];

        // Process each notification to ensure timeAgo is set
  ...
  function updateNotificationCount() {
    $.ajax({
      ...
      method: 'GET',
      success: function(response) {
        // Extract count from ResultData wrapper
        const data = response.data || {};
  ...
  function openNotificationDetail(notificationId) {
    $.ajax({
      ...
      method: 'GET',
      success: function(response) {
        // Extract notification from ResultData wrapper
